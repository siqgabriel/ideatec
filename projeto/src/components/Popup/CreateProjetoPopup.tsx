...
interface PopupCriarProjetoProps {
  children: ReactNode;
...
export default function PopupCriarProjeto({ children, onClose, showPopup, togglePopup }: PopupCriarProjetoProps) {
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        alert(`Erro ao criar o projeto: ${errorData.msg}`);
        return;
      }
